        ...
        <div className="bg-[#F4F5F9] min-h-screen">
            ...
            <header className="flex flex-row justify-between px-4 py-3 md:p-4 items-center border-b border-gray-200 bg-white sticky top-0 z-50">
                <div className="flex flex-row gap-2 sm:gap-5 items-center justify-center">
                    ...
                    <h1 className="font-['bebas-neue'] font-bold text-[20px] sm:text-[24px] md:text-[30px] text-[#6E39CB] leading-4 tracking-normal">MetaTix</h1>
                </div>
            ...
            <div className="relative w-full h-[60vh] md:h-125 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start px-6 md:px-12">
                    ...
                    <h2 className="text-white font-['bebas-neue'] text-4xl sm:text-5xl md:text-7xl font-bold leading-tight mt-4">
                        YOUR GATEWAY TO <br /> <span className="text-[#6E39CB]">UNFORGETTABLE</span> MOMENTS
                    </h2>
                    <p className="text-white font-['Lato'] text-base md:text-xl mt-3 md:mt-4 max-w-xl">
            ...
            <div ref={eventsSectionRef} className="px-4 py-8 md:p-12 scroll-mt-20"> 
                <h2 className="font-['Lato'] font-bold text-[20px] md:text-[24px] mb-4 md:mb-6 text-[#2D2D2D]">Upcoming Events</h2>
                
                {loading ? (
                    <div className="text-center text-gray-500 py-10 text-lg md:text-xl font-['Lato']">Loading events from database...</div>
                ) : allEvents.length === 0 ? (
                    <div className="text-center text-gray-500 py-10 text-lg md:text-xl font-['Lato']">No events currently scheduled. Check back soon!</div>
                ) : (
                    <>
                        ...
                        <div className="flex flex-wrap justify-center items-center mt-8 md:mt-12 gap-3 md:gap-4">
                            ...
                            <span className="font-['Lato'] font-medium text-gray-700 text-sm md:text-base">
